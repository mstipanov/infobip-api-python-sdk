...
from infobip_platform.number.models.body.number_configuration import UpdateNumberConfigurationBody
...
from infobip_platform.number.models.query_parameters.number_purchase import GetPurchasedNumbersQueryParameters, GetAvailableNumbersQueryParameters
...
from infobip_platform.number.models.response.responses import NumberConfigurationResponse
...
class NumberBrands(Channel):
    ...
    # def get_available_numbers(self, query_parameters: Union[GetAvailableNumbersQueryParameters, Dict] = None) -> Union[ResponseBase, Any]:
    ...
    #
    # def get_purchased_numbers(self, query_parameters: Union[GetPurchasedNumbersQueryParameters, Dict] = None) -> Union[ResponseBase, Any]:
    ...
    #
    # def update_number_configuration(self, number_key: str, number_configuration: UpdateNumberConfigurationBody) -> Union[ResponseBase, Any]:
    #     """Get a paginated list of entities.
    #
    #     :return Response with a list of Entity objects.
    #     """
    #     response = self._client.put(self.NUMBERS_PATH_VERSION_2 + f"numbers/{number_key}/sms", number_configuration.dict(by_alias=False))
    #     return self._construct_response(response, UpdateNumberConfigurationResponse)
