...
from infobip_platform.core.models import ResponseBase
from infobip_platform.number import NumberSetting
...
def set_up_mock_server_and_send_request(
    ...
    return getattr(sms_channel, method_name)(request_query_parameters, message_body)
